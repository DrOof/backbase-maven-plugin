...
/**
 * Goal which imports basic widgets.
 */
@Mojo(name = "import-basic-widgets", defaultPhase = LifecyclePhase.PROCESS_SOURCES)
public class ImportBasicWidgets extends BaseMojo {
